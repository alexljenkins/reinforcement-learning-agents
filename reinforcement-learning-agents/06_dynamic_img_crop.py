...
class DQN(nn.Module):
    ...
    def __init__(self, img_height, img_width):
        ...
        self.fc1 = nn.Linear(in_features = img_height*img_width*3, out_features = 40)

        self.fc2 = nn.Linear(in_features = 40, out_features = 120)
...
class Simulation():
    ...
    def initialize_static_values(self):
        ...
        self.epochs = 500 # epochs before saving and quitting
