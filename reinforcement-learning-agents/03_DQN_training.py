...
class DQN(nn.Module):
    ...
    def __init__(self, img_height, img_width):
        ...
        self.maxpool1 = nn.MaxPool2d(kernel_size=5, stride=2, padding=1)
        self.bn1 = nn.BatchNorm2d(8)
        self.conv2 = nn.Conv2d(8, 12, 5, 1)
...
if __name__ == '__main__':
    ...
    # try:
    #     model.load_state_dict(torch.load('pretrained_models/cartpole_weights.pth'))
    # except:
    #     pass
    ...
    for episode in range(num_episodes):
        ...
        if episode % num_episodes == 0:
            em.close()
        #     torch.save(policy_net.state_dict(), 'pretrained_models/cartpole_weights.pth')
        #     torch.save(policy_net, "pretrained_models/cartpole.pth")
